...
def get_constraints(m: AbstractModel, region_weights=None) -> Sequence[GeneralConstraint]:
    """

    <h3>Weighted Welfare-loss-minimising setting</h3>
    ...
    m.region_weights = Param(m.regions)
        ...
        [
            RegionalEquation(
                ...
                lambda m, t, r: calc_utility(
                    m.consumption[t, r], m.population[t, r], m.elasmu, m.region_weights[r]
                ),
            ),
            GlobalEquation(
                m.yearly_welfare,
